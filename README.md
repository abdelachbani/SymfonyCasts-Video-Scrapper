## A script that allows you to download all the videos with their subtitles from any course of the SymfonyCasts platform, with the execution of a single command.
